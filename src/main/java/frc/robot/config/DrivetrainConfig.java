...
import frc.robot.subsystem.KopDrive;
...
public class DrivetrainConfig {
    public static BoxDrive configBoxDrive(BoxDrive drivetrain, Lifter lifter) {
    ...
    public static KopDrive configKopDrive(KopDrive drivetrain, Lifter lifter) {
        LifterUpDeceleration decelerationBindableValue = new LifterUpDeceleration(lifter);
        ...
        drivetrain.setSlewRateLimiters(Optional.of(frontBackSRL.cloneSRL()), Optional.of(frontBackSRL.cloneSRL()));    
